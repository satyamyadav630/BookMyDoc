...
const SpecialityMenu = () => {
  return (
    <div className="flex flex-col items-center gap-4 py-16 text-gray-800 "  id='speciality'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of and good trusted doctores, schedule your appointment hassele-free</p>
